...
```r
packages <- c("cowplot", "data.table", "doParallel", "doRNG", "dplyr", "foreach", "forcats", "fs", "ggh4x", "ggplot2", "ggthemes", "glue", "gstat", "ineq", "iterators", "lubridate", "parallel", "purrr", "raster", "readr", "rngtools", "R.utils", "sf", "sp", "spData", "spdep", "stringr", "tibble", "tidyr", "tidyverse", "vroom")
